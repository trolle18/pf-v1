            ...
            <div class="oc-plugin-redesign-notices">
                <div class="oc-plugin-redesign-notices-wrap">
                    <div class="oc-plugin-redesign-notices-desc">
                        <p class="welcome_text"><?php echo sprintf(__('Welcome to %s plugins', OC_VALIDATOR_DOMAIN),'<img src="'.$img_url.'" alt="'.__("one.com", OC_VALIDATOR_DOMAIN).'">'); ?></p>
                        ...
                        <p><?php echo __('All to build your dream online.',OC_VALIDATOR_DOMAIN);?></p>
                    </div>
